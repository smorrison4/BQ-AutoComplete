...
function setBq4ByIndex(index) {
	if (index < 0 || index >= Bq4Lst.length) { return; }
	var item = Bq4Lst[index];
	setBq4ByItem(item);
}
function setBq4ByKey(key) {
	var jMax = Bq4Lst.length;
	var item = null;
