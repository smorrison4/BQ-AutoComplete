...
function setBq6ByIndex(index) {
	if (index < 0 || index >= Bq6Lst.length) { return; }
	var item = Bq6Lst[index];
	setBq6ByItem(item);
}
function setBq6ByKey(key) {
	var jMax = Bq6Lst.length;
	var item = null;
