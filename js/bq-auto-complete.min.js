...
var bqAC=function () {
function e(e){function t(e,t) { return e.classList ? e.classList.contains(t) : new RegExp('\\b'+t+'\\b').test(e.className)} function o(e,t,o) { e.attachEvent ? e.attachEvent('on'+t,o) : e.addEventListener(t,o)} function s(e,t,o) { e.detachEvent ? e.detachEvent('on'+t,o) : e.removeEventListener(t,o)} function n(e,s,n,l) { o(l || document,s,function (o) { for (var s,l=o.target || o.srcElement; l && !(s=t(l,e)) ;) l=l.parentElement; s && n.call(l,o)})} if (document.querySelector) {
...
var i=a[u]; i.sc=document.createElement('div'),
i.sc.className='ac-sugs '+l.menuClass,i.autocompleteAttr=i.getAttribute('autocomplete'),
...
i.blurHandler=function () {
	try { var e=document.querySelector('.ac-sugs:hover')} catch (t) { var e=0} e ? i!==document.activeElement && setTimeout(function () { i.focus()},20) : (i.last_val=i.value,i.sc.style.display='none',
		setTimeout(function () {},350))
},
o(i,'blur',i.blurHandler);
var r9=function (e) {
	if (i.value==='*') { i.value='* ';}
	var t=i.value; if (i.cache[t]=e,e.length && t.length >= l.minChars) { for (var o='',s=0; s < e.length; s++) o += l.renderItem(e[s],t); i.sc.innerHTML=o,i.updateSC(0)} else i.sc.style.display='none'
};
...
i.keyupHandler=function (e) {
	var t=window.event ? e.keyCode : e.which; if (!t || (35 > t || t > 40) && 13!==t && 27!==t) {
		var o=i.value;
		if (o.indexOf('*') !== -1) {
			// Comment this out if have two kinds
			if (e.srcElement.bqItem.ctrl===undefined || e.srcElement.bqItem.ctrl!=='bq2') {
			...
			i.timer = setTimeout(function () { l.source(o, e.srcElement, r9) }, l.delay)
		}
		else if (o.length >= l.minChars) {
			if (o!==i.last_val) {
				if (i.last_val=o, clearTimeout(i.timer), l.cache) {
				...
				if (typeof e.srcElement.bqItem==='undefined') {
					e.srcElement.bqItem={ ctrl: '', selectedItem: '', longName: '', dataChoice: ''};
				}
				i.timer=setTimeout(function () { l.source(o,e.srcElement,r9)},l.delay);
			}
		}
