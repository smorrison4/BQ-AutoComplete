...
var r9=function (e) {
var t=i.value; if (i.cache[t]=e,e.length && ((t.length >= l.minChars) || (t.indexOf('*') != -1) || (t.indexOf(':') != -1))) {for (var o='',s=0; s < e.length; s++) o += l.renderItem(e[s],t); i.sc.innerHTML=o,i.updateSC(0)} else i.sc.style.display='none'
};
...
i.keyupHandler=function (e) {
	var t=window.event ? e.keyCode:e.which; if (!t || (35 > t || t > 40) && 13!==t && 27!==t) {
		var o=i.value;
		if (e.target.bqItem===undefined) {
			e.target.bqItem={ctrl:'',selectedItem:'  ',longName:'',dataChoice:''};
		}
		...
		else if ((o.length >= l.minChars) || (o.indexOf('*') != -1) || (o.indexOf(':') != -1)) {
			if (o!==i.last_val) {
				if (i.last_val=o,clearTimeout(i.timer),l.cache) {
