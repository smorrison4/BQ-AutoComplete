...
var r9=function (e) {if (i.value==='*') {i.value='* ';}
...
i.keyupHandler=function (e) {
	var t=window.event ? e.keyCode:e.which; if (!t || (35 > t || t > 40) && 13!==t && 27!==t) {
		var o=i.value;
		if (e.srcElement.bqItem===undefined) {
			e.srcElement.bqItem={ctrl:'',selectedItem:'  ',longName:'',dataChoice:''};
		}
		if (e.srcElement.bqItem.selectedItem==='* ') {o='* '; }
		if (o.indexOf('*') !== -1) {
		...
		else if (aLvl!==undefined) {i.last_val=o,i.sc.style.display='none';}
	}
},
