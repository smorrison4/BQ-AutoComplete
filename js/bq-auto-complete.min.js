...
var bqACFcn=function () {function e(e){function t(e,t) {return e.classList ? e.classList.contains(t):new RegExp('\\b'+t+'\\b').test(e.className)} function o(e,t,o) {e.attachEvent ? e.attachEvent('on'+t,o):e.addEventListener(t,o)} function s(e,t,o) {e.detachEvent ? e.detachEvent('on'+t,o):e.removeEventListener(t,o)} function n(e,s,n,l) {o(l || document,s,function (o) {for (var s,l=o.target || o.srcElement; l && !(s=t(l,e)) ;) l=l.parentElement; s && n.call(l,o)})} if (document.querySelector) {
...
var r9 = function (e) {
	if (i.value.indexOf('&') != -1) {console.log('t = ' + i.value);}
	var t = i.value;
...
i.keyupHandler=function (e) {
	var t=window.event ? e.keyCode:e.which; if (!t || (35 > t || t > 40) && 13!==t && 27!==t) {
		...
		if (o.indexOf('*') !== -1) {
			...
			if (e.target.bqItem.ctrl===undefined || e.target.bqItem.ctrl!=='bqac2') {
		...
		// Bug here. Once you set chars, go bakc to 0 chars, and then set chars again, it waits until 3 chars.
		else if (o.length < l.minChars) { i.lastVal = ''; i.sc.style.display = 'none'; }
	}
},
...
}(); !function () {'function'===typeof define && define.amd ? define('bqACFcn',function () {return bqACFcn}):'undefined'!==typeof module && module.exports ? module.exports=bqACFcn:window.bqACFcn=bqACFcn}();
