...
function setbqac3ByIndex(index) {
	if (index < 0 || index >= bqac3Lst.length) { return; }
	var item = bqac3Lst[index];
	setbqac3ByItem(item);
}
function setbqac3ByKey(key) {
	var jMax = bqac3Lst.length;
	var item = null;
