...
function setbqac5ByIndex(index) {
	if (index < 0 || index >= bqac5Lst.length) { return; }
	var item = bqac5Lst[index];
	setbqac5ByItem(item);
}
function setbqac5ByKey(key) {
	var jMax = bqac5Lst.length;
	var item = null;
